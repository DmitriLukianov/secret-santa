...
func (uc *UseCase) GetForUser(ctx context.Context, userID uuid.UUID) ([]entity.Notification, error) {
	if userID == uuid.Nil {
...
func (uc *UseCase) MarkAsRead(ctx context.Context, id, userID uuid.UUID) error {
